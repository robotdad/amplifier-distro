...
# Inlined from amplifier_distro.conventions
_AMPLIFIER_HOME = "~/.amplifier"
...
class VoiceConversationRepository:
    ...
    def write_to_amplifier_transcript(
        ...
        *,
        ...
        visibility."""
        home = amplifier_home or Path(_AMPLIFIER_HOME).expanduser()
        amplifier_dir = home / _PROJECTS_DIR / project_id / "sessions" / session_id
        amplifier_dir.mkdir(parents=True, exist_ok=True)
        transcript_path = amplifier_dir / _TRANSCRIPT_FILENAME
